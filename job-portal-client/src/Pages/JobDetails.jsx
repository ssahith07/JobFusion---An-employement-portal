...
//   const [New, setNew] = useState(false); // After page render to know if the user has applied for the job
...
//         .then((data) => {
//           console.log(data);
//           setApplied(data.jobsApplied);
//           setApp(applied.find((item) => item === _id));
//         });
//     } catch (error) {
...
//                     className="bg-green px-8 py-2 my-2 text-white rounded-full"
//                     onClick={() => {
//                       alert("Upload resumee to apply for jobs");
//                     }}
//                   >
//                     Apply Now
//                   </button>
...
//                     Applied
//                   </button>
//                   <span className="px-4 font-normal text-gray-500">
//                     * if you are selected you will receive email or receive call
//                     to mobile number.
//                   </span>
//                 </>
//               )}
