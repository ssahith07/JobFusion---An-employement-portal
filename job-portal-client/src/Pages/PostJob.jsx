    ...
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
      <div className="bg-[#FAFAFA] py-10px-4 lg:px-16">
        <div className="flex py-4">
          <button
            className={`inline-block mr-4 px-4 ${
              sect === "private" ? "bg-white text-blue" : "bg-blue text-white"
            } border border-solid border-blue rounded cursor-pointer transition duration-100 ease-in-out  hover:bg-white hover:text-blue focus:outline-none focus:ring focus:border-blue`}
          ...
          <button
            className={`inline-block px-4 py-2 border border-solid ${
              sect === "govt" ? "bg-white text-green" : "bg-green text-white"
            } border-green rounded cursor-pointer transition duration-100 ease-in-out hover:bg-white hover:text-green focus:outline-none focus:ring focus:border-green-300`}
        ...
        {sect === "private" ? (
          ...
          <form onSubmit={handleSubmit(onSubmitg)} className="space-y-5 py-5">
            ...
            <div className="create-job-flex">
              <div className="lg:w-1/2 w-full">
                <label className="block mb-2 text-lg">
                  Governement Job link
                </label>
                <input
                  type="url"
                  placeholder="Paste your company logo URL: https://"
                  {...register("govtlink")}
                  className="create-job-input"
                  required
                />
            ...
            {/* 8th row */}
            <div className="w-full">
              <label className="block mb-2 text-lg">Recruiter Email</label>
              <input
                type="email"
                pattern="[^ @]*@[^ @]*"
                placeholder="Your email"
