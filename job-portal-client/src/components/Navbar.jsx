          ...
          {token ? (
            <>
              ...
              <Link
                ...
                className="py-2 px-5 border rounded bg-white hover:bg-red-500 hover:text-white"
              >
                Logout
              </Link>
            </>
            ...
            <>
              <Link
                to="/login"
                className="py-2 px-5 border rounded bg-white hover:bg-gray-200"
              >
                Login
              </Link>
              <Link
                to="/sign-up"
                className="py-2 px-5 border rounded bg-blue text-white hover:bg-cyan-500"
              >
                SignUp
              </Link>
            </>
